...
Shader "Malbers/Gradient4"
{
	Properties
	{
		...
		[Header(Color 1)]_Color1Top("Top (A: Rough)", Color) = (1,0.8742833,0.481132,1)
		_Color1Bottom("Bottom (A: Metallic)", Color) = (0.335849,0.1012578,0.03992166,0)
		[HDR]_Color1Emmission("Emmission", Color) = (0,0.1124103,0.4056604,0)
		_Power1("Power", Float) = 1
		[Header(Color 2)]_Color2Top("Top (A: Rough)", Color) = (0,1,0.1024554,1)
		_Color2Bottom("Bottom (A: Metallic)", Color) = (0,0.2549422,0.4039216,0)
		[HDR]_Color2Emmission("Emmission", Color) = (0,0.1124103,0.4056604,0)
		_Power2("Power", Float) = 1
		[Header(Color 3)]_Color3Top("Top (A: Rough)", Color) = (1,0,0.6080093,1)
		_Color3Bottom("Bottom (A: Metallic)", Color) = (1,1,1,0)
		[HDR]_Color3Emmission("Emmission", Color) = (0,0.1124103,0.4056604,0)
		_Power3("Power", Float) = 1
		[Header(Color 4)]_Color4Top("Top (A: Rough)", Color) = (0.7660377,0.6128575,0.07371305,1)
		_Color4Bottom("Bottom (A: Metallic)", Color) = (0.5666292,1,0.3226415,0.1529412)
		[HDR]_Color4Emmission("Emmission", Color) = (0,0.1124103,0.4056604,0.7058824)
		_Power4("Power", Float) = 1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float Gradient223 = ( ( 1.0 - temp_output_11_0 ) * step( i.uv_texcoord.x , 0.5 ) );
...
/*ASEBEGIN
Version=19403
Node;AmplifyShaderEditor.CommentaryNode;36;-2864,-816;Inherit;False;1149.969;892.7399;Gradients;14;24;22;23;25;26;18;8;11;15;19;20;21;16;17;;1,1,1,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;8;-2816,-512;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;11;-2480,-720;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.25;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;18;-2464,-224;Inherit;False;2;0;FLOAT;0.75;False;1;FLOAT;0.25;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;16;-2272,-640;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;20;-2320,-352;Inherit;False;2;0;FLOAT;0.5;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;19;-2336,-256;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;15;-2256,-512;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;26;-2496,-96;Inherit;False;DefaultGradient;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-1408.678,-1038.686;Inherit;False;Property;_Power1;Power;4;0;Create;False;0;0;0;False;0;False;1;1.92;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;120;-1402.61,-91.06691;Inherit;False;Property;_Power2;Power;8;0;Create;False;0;0;0;False;0;False;1;-0.7;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;155;-1409.775,1876.104;Inherit;False;Property;_Power4;Power;16;0;Create;False;0;0;0;False;0;False;1;1.27;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;142;-1398.014,871.7491;Inherit;False;Property;_Power3;Power;12;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-2112,-608;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-2144,-336;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;122;-1426.804,-585.7639;Inherit;False;Property;_Color2Bottom;Bottom (A: Metallic);6;0;Create;False;0;0;0;False;0;False;0,0.2549422,0.4039216,0;0.2679245,0.2243782,0.2077678,0.2901961;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;140;-1422.209,375.0301;Inherit;False;Property;_Color3Bottom;Bottom (A: Metallic);10;0;Create;False;0;0;0;False;0;False;1,1,1,0;0.335849,0.09821991,0.1208368,0.4;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;153;-1433.97,1381.407;Inherit;False;Property;_Color4Bottom;Bottom (A: Metallic);14;0;Create;False;0;0;0;False;0;False;0.5666292,1,0.3226415,0.1529412;0.4113207,0.08499948,0.07372723,0.8823529;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;5;-1436.751,-1703.258;Inherit;False;Property;_Color1Top;Top (A: Rough);1;1;[Header];Create;False;1;Color 1;0;0;False;0;False;1,0.8742833,0.481132,1;1,0.8573503,0.5943396,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;6;-1432.872,-1533.384;Inherit;False;Property;_Color1Bottom;Bottom (A: Metallic);2;0;Create;False;0;0;0;False;0;False;0.335849,0.1012578,0.03992166,0;0.737255,0.4392157,0.5870367,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;118;-1430.683,-755.638;Inherit;False;Property;_Color2Top;Top (A: Rough);5;1;[Header];Create;False;1;Color 2;0;0;False;0;False;0,1,0.1024554,1;0.1320755,0.1012642,0.08846562,0.5803922;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;143;-1426.087,207.1772;Inherit;False;Property;_Color3Top;Top (A: Rough);9;1;[Header];Create;False;1;Color 3;0;0;False;0;False;1,0,0.6080093,1;1,0.7561119,0.126415,0.7215686;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;156;-1437.848,1211.533;Inherit;False;Property;_Color4Top;Top (A: Rough);13;1;[Header];Create;False;1;Color 4;0;0;False;0;False;0.7660377,0.6128575,0.07371305,1;1,0.6384831,0.1339622,0.1882353;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;25;-1920,-768;Inherit;True;Gradient1;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;23;-1920,-560;Inherit;True;Gradient2;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;22;-1920,-352;Inherit;True;Gradient3;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;24;-1920,-144;Inherit;True;Gradient4;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;124;-864,-432;Inherit;False;23;Gradient2;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;53;119.0074,-847.8591;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;154;-1438.069,1579.672;Inherit;False;Property;_Color4Emmission;Emmission;15;1;[HDR];Create;False;0;0;0;False;0;False;0,0.1124103,0.4056604,0.7058824;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;168;423.5345,-882.4908;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;170;576,-480;Inherit;False;Property;_Lit;Lit;17;0;Create;True;0;0;0;False;0;False;0;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;78;736,-880;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;171;880,-400;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OneMinusNode;158;688,-560;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;169;1088,-384;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1440,-592;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Malbers/Gradient4;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Off;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0.01;0,0,0,0;VertexScale;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=197F24A9DD6253E57C4F25A490A7168D9FEB3442